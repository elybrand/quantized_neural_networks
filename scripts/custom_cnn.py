...
ParamConfig = namedtuple('ParamConfig', 'data_set, trial_idx, np_seed, tf_seed, rectifier, kernel_init, kernel_size, stride, train_batch_size, epochs, q_train_size, ignore_layer')
